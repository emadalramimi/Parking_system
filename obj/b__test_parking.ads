...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_test_parking" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#6b4c5acc#;
   pragma Export (C, u00001, "test_parkingB");
   ...
   u00137 : constant Version_32 := 16#d615a251#;
   pragma Export (C, u00137, "parkingB");
   u00138 : constant Version_32 := 16#b0810340#;
   pragma Export (C, u00138, "parkingS");
   u00139 : constant Version_32 := 16#3ccf6f21#;
   pragma Export (C, u00139, "voitureB");
   u00140 : constant Version_32 := 16#85ddeda3#;
   pragma Export (C, u00140, "voitureS");
